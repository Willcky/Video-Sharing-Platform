...
import org.dromara.vrsauth.properties.CaptchaProperties;
import org.dromara.vrsauth.properties.UserPasswordProperties;
...
public class SysLoginService {
    ...
    public void register(RegisterBody registerBody) {
        ...
        recordLogininfor(email, username, Constants.REGISTER, MessageUtils.message("user.register.success"));
    }
     ...
     * @return
     */
    public void recordLogininfor(String email, String username, String status, String message) {
        // 封装对象
        LogininforEvent logininforEvent = new LogininforEvent();
        logininforEvent.setTenantId(email);
    ...
    public void checkLogin(LoginType loginType, String username, Supplier<Boolean> supplier) {
        ...
        if (errorNumber >= maxRetryCount) {
            recordLogininfor(username, username, loginFail, MessageUtils.message(loginType.getRetryLimitExceed(), maxRetryCount, lockTime));
        ...
        if (supplier.get()) {
            ...
            if (errorNumber >= maxRetryCount) {
                ...
                // 未达到规定错误次数
                recordLogininfor(username, username, loginFail, MessageUtils.message(loginType.getRetryLimitCount(), errorNumber));
